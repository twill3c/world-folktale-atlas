...
const PAGES = [
  ...
  ["/stories/", ["民話をさがす", "本文から探す", "意味で探す(ブラウザの中だけで動く)"]],
  ["/space/", ["意味の空間", "軸に意味はない"]],
  ["/clusters/", ["機械がまとめた群", "シルエット係数"]],
  ["/network/", ["似ている民話のつながり", "線は伝播の経路ではない"]],
  ["/compare/", ["並べて読む", "民話を足す"]],
  ["/regions/", ["文化圏くらべ", "この表から文化の性質を読み取ってはいけない"]],
  ["/classic/", ["古い道具で測る", "半分割", "Burrows の Delta", "対応分析", "トピックモデル(LDA)", "語りの状態列"]],
  ["/gates/", ["測ったこと", "H-01", "地理と意味に相関がある", "分離できていない", "H-04a", "H-05a", "H-06", "G-21", "G-18b", "H-09"]],
  ["/about/", ["採るときの条件", "採らなかったもの", "収録した本", "1888 年に英国人", "機械に何ができて"]],
  ["/translations/", ["和訳のすすみ", "この和訳が何であるか", "文化圏ごとのすすみ"]],
  ["/story/GB-7439-024/", ["和訳対照", "左＝原文(原資料)", "右＝和訳(AI が作ったもの)"]],
  ["/story/DE-2591-036/", ["出典と権利", "緊張のうつりかわり", "似ている民話", "話を刻んで比べた近傍"]],
  ...
  ["/story/JP-29287-003/", ["和訳対照", "昔は犬も口をきくことができた", "語り手イシャナシテ"]],
];
