...
const PAGES = [
  ...
  ["/stories/", "民話をさがす", ["民話をさがす", "本文から探す", "意味で探す(ブラウザの中だけで動く)"]],
  ...
  ["/classic/", "古い道具で測る", ["古い道具で測る", "半分割", "Burrows の Delta", "対応分析"]],
  ["/gates/", "測ったこと", ["測ったこと", "H-01", "地理と意味に相関がある", "分離できていない", "H-04a", "H-04b", "H-05a", "H-05b", "H-06"]],
  ["/about/", "このアトラスについて", ["採るときの条件", "収録した本", "採らなかったもの", "1888 年に英国人"]],
  ["/translations/", "和訳のすすみ", ["和訳のすすみ", "この和訳が何であるか", "文化圏ごとのすすみ"]],
  ["/story/GB-7439-024/", "対訳", ["和訳対照", "左＝原文(原資料)", "右＝和訳(AI が作ったもの)"]],
  ...
  // L10: 新しい文化圏の対訳(アイヌ本の採話者の署名まで訳す)
  ["/story/JP-29287-003/", "対訳(アイヌ)", ["和訳対照", "昔は犬も口をきくことができた", "語り手イシャナシテ"]],
];
